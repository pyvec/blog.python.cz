...
Z české komunity se zapojila spousta lidí, někteří jako dobrovolníci nebo přímo v organizačním týmu, další i na pódiu. Karolína měla přednášku o open source z pohledu někoho, kdo upstream udržuje 200 knihoven, praktický přehled toho, co by měl vědět každý open source maintainer. Lumír s Mirem tu navíc měli lightning talk o tom, jak správně vyslovovat PyPI (většina lidí říká PyPy, což je ale úplně jiný projekt!s).
